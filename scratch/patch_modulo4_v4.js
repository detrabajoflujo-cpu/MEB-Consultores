...
const data = fs.readFileSync('n8n-workflows/modulo-4-recoleccion-expediente-v4.json', 'utf8');
...
fs.writeFileSync('n8n-workflows/modulo-4-recoleccion-expediente-v5.json', JSON.stringify(workflow, null, 2));
console.log('Successfully generated modulo-4-recoleccion-expediente-v5.json');
