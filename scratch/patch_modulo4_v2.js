...
(function() {
  ...
  if (validacion.expedienteCompleto) {
      return {
...
fs.writeFileSync('n8n-workflows/modulo-4-recoleccion-expediente-v3.json', JSON.stringify(workflow, null, 2));
console.log('Successfully generated modulo-4-recoleccion-expediente-v3.json');
